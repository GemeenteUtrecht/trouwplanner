/* The event Cotroller */
dashboard.controller('huwelijkCtrl', ['$scope','$rootScope','$state','$stateParams','ConductionAPI','session',  function($scope,$rootScope, $state, $stateParams, ConductionAPI,session ) {
