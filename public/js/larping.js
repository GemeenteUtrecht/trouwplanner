...
larping.config(['$urlRouterProvider', '$stateProvider','$locationProvider','$controllerProvider', '$provide','$translateProvider', function($urlRouterProvider, $stateProvider, $locationProvider,$controllerProvider,$provide,$translateProvider) {
    ...
    .state('productEdit', {
        url : '/edit/{id:\d*}',
        parent : 'products',
        templateUrl: 'templates/organisation/product.html',
    ...
    .state('invoices', {
        url: '/invoices',
        templateUrl: 'templates/organisation/invoices.html',
    ...
    .state('invoiceEdit', {
        url : 'edit/{id:\d*}',
        parent : 'invoices',
        templateUrl: 'templates/organisation/invoice.html',
    ...
    //Administration menu
    .state('administration.invoices', {
        url: '/invoices',
        templateUrl: 'templates/administration/invoices.html'
    })
    .state('administration.invoices.detail', {
        url : '/{id:\d*}',
        templateUrl: 'templates/administration/invoice.html',
    })
    .state('administration.declarations', {
        url: '/templates',
        templateUrl: 'templates/administration/declarations.html'
    })
    .state('administration.declarations.detail', {
        url : '/{id:\d*}',
        templateUrl: 'templates/administration/declaration.html',
    })
    .state('administration.belance', {
        url: '/templates',
        templateUrl: 'templates/administration/belance.html'
    })
    // Setting menu
    ...
    .state('setting.templates.detail', {
        url : '/{id:\d*}',
    ...
    .state('organisations', {
        url: '/organisations',
        templateUrl: 'templates/organisation/organisations.html',
        controller: 'organisationsCtrl',
        resolve: {
        	organisations: function(ConductionOrganisation, $transition$) {
        		return ConductionOrganisation.query();
        	}
        }
    })
    .state('organisation', {
        ...
        templateUrl: 'templates/organisation/organisation.html',
    ...
    .state('organisation-dashboard', {
    	url : '/dashboard',
        parent : 'organisation',
        templateUrl: 'templates/organisation/dashboard.html',
        controller: 'organisationCtrl',
        resolve: {
        	organisation: function(ConductionOrganisation, $transition$) {
        		return ConductionOrganisation.get({id:$transition$.params().id});
    ...
    .state('organisation-clients', { // Lets pay attention here players in conduction terms is a psudo for clients
    	url : '/players', // lets also pseudo the routing
        parent : 'organisation',
        templateUrl: 'templates/organisation/clients.html',
        ...
        resolve: {
			...
			clients: function(ConductionClient, $transition$) {
				return ConductionClient.query({organisation:$transition$.params().id});
			}
        }
    })
    ...
    .state('organisation-administration', {
    	url : '/administration',
        parent : 'organisation',
        templateUrl: 'templates/organisation/administration.html',
        controller: 'organisationCtrl',
        resolve: {
        	organisation: function(ConductionOrganisation, $transition$) {
        		return ConductionOrganisation.get({id:$transition$.params().id});
    ...
    .state('organisation-settings', {
    	url : '/settings',
        parent : 'organisation',
        templateUrl: 'templates/organisation/settings.html',
        controller: 'organisationCtrl',
        resolve: {
        	organisation: function(ConductionOrganisation, $transition$) {
        		return ConductionOrganisation.get({id:$transition$.params().id});
    ...
    .state('organisation-add', {
        url : '/add',
        parent : 'organisations',
        templateUrl: 'templates/organisation/add.html',
        controller: 'organisationsCtrl',
        resolve: {
    ...
    .state('organisation-edit', {
        url : '/edit',
        parent : 'organisations',
        templateUrl: 'templates/organisation/edit.html',
        controller: 'organisationCtrl',
        resolve: {
        	organisation: function(ConductionOrganisation, $transition$) {
        		return ConductionOrganisation.get({id:$transition$.params().id});
